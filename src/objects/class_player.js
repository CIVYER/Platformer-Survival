class Player{
    constructor({position, collisionBlocks, weapon}){
        ...
        this.walkingLeft = '../src/sprites/walkingLeft.png';
        this.walkingRight = '../src/sprites/walkingRight.png';
        this.jumpingLeft = '../src/sprites/jumpLeft.png';
        this.jumpingRight = '../src/sprites/jumpRight.png';
        this.frame = 0;
        this.jumpFrame = 0;
